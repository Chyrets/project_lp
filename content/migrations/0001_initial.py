# Generated by Django 4.0 on 2022-01-11 16:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.IntegerField(db_index=True, verbose_name='pk объекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='content.comment')),
